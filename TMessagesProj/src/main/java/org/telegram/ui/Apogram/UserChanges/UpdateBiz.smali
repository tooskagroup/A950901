.class public Lorg/telegram/ui/Apogram/UserChanges/UpdateBiz;
.super Ljava/lang/Object;
.source "UpdateBiz.java"


# instance fields
.field private dba:Lorg/telegram/ui/Apogram/UserChanges/a;
...
.method public constructor <init>()V
    ...
    .line 10
    new-instance v0, Lorg/telegram/ui/Apogram/UserChanges/a;

    invoke-direct {v0}, Lorg/telegram/ui/Apogram/UserChanges/a;-><init>()V

    iput-object v0, p0, Lorg/telegram/ui/Apogram/UserChanges/UpdateBiz;->dba:Lorg/telegram/ui/Apogram/UserChanges/a;
...
.method public insertUpdate(Lorg/telegram/tgnet/TLRPC$User;Lorg/telegram/tgnet/TLRPC$Update;)Z
    ...
    invoke-direct {v0}, Lorg/telegram/ui/Apogram/UserChanges/UpdateModel;-><init>()V

    .line 43
    .local v0, "updateModel":Lorg/telegram/ui/Apogram/UserChanges/UpdateModel;
    iget v4, p1, Lorg/telegram/tgnet/TLRPC$User;->id:I

    invoke-virtual {v0, v4}, Lorg/telegram/ui/Apogram/UserChanges/UpdateModel;->setUserId(I)V

    .line 44
    const/4 v4, 0x1

    invoke-virtual {v0, v4}, Lorg/telegram/ui/Apogram/UserChanges/UpdateModel;->setNew(Z)V
    ...
    invoke-direct {p0, v4, v5, v6}, Lorg/telegram/ui/Apogram/UserChanges/UpdateBiz;->formatUserSearchName(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v0, v4}, Lorg/telegram/ui/Apogram/UserChanges/UpdateModel;->setOldValue(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v4}, Lorg/telegram/ui/Apogram/UserChanges/UpdateModel;->setNewValue(Ljava/lang/String;)V

    .line 48
    const/4 v4, 0x2

    invoke-virtual {v0, v4}, Lorg/telegram/ui/Apogram/UserChanges/UpdateModel;->setType(I)V

    .line 62
    :goto_2
    iget-object v4, p0, Lorg/telegram/ui/Apogram/UserChanges/UpdateBiz;->dba:Lorg/telegram/ui/Apogram/UserChanges/a;

    invoke-virtual {v4, v0}, Lorg/telegram/ui/Apogram/UserChanges/a;->a(Lorg/telegram/ui/Apogram/UserChanges/UpdateModel;)Ljava/lang/Long;
